...
const HeadLogin = ({ setIsLoggedIn }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const res = await fetch(`${BACKEND_URL}/api/accounts/login/head`, {
        method: 'POST',
    ...
    <div style={{
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ margin: 0, color: '#2563eb', fontWeight: 800, fontSize: '2rem', letterSpacing: '1px', textAlign: 'center' }}>RUET Head Login</h2>
        </div>
        ...
        <div style={{ textAlign: 'center', margin: '1.5rem 0 0 0', color: '#64748b', fontWeight: 500 }}>
          ...
          <Link to="/head-signup" style={{ color: '#2563eb', textDecoration: 'underline', fontWeight: 600 }}>
            Sign up
          </Link>
        </div>
