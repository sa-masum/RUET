...
const HeadProfile = () => {
  ...
  useEffect(() => {
    fetch(`${BACKEND_URL}/api/accounts/get_profile/head`, {
      method: 'GET',
      credentials: 'include'
    })
      .then(res => res.json())
  ...
  const handleSave = async () => {
    ...
    setSuccess('');
    try {
      const res = await fetch(`${BACKEND_URL}/api/accounts/update_profile/head`, {
        method: 'POST',
          ...
          <div style={{ width: '100%' }}>
            ...
            <div className="grid">
              ...
              <div className="form-group">
                ...
                <input 
                  name="designation" 
                  value={profile.designation || 'Department Head'} 
                  disabled 
                  style={inputStyle} 
                />
              </div>
